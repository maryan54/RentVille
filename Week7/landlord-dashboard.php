...
<head>
    ...
    <title>Landlord Dashboard — RentVille</title>
...
<nav>
    ...
    <div class="nav-links">
        <span style="color:rgba(255,255,255,0.85);font-size:13px;margin-right:8px;">
            Landlord: <?= htmlspecialchars($user_name) ?>
        </span>
...
<div class="page">
    ...
    <div class="card">
        ...
        <p style="color:#666;margin-top:4px;">Manage your tenants and properties.</p>
    </div>
    ...
    <div class="card">
        <div class="flex-between">
            <h2 style="margin:0;">Your Tenants</h2>
        ...
        <?php else: ?>
            ...
            <div class="tenant-row">
                ...
                <div class="tenant-actions">
                    <a href="edit-tenant.php?id=<?= $t['id'] ?>" class="btn btn-outline btn-sm">Edit</a>
                    <a href="landlord-dashboard.php?toggle=<?= $t['id'] ?>" class="btn btn-outline btn-sm">
                        <?= $t['status'] === 'Active' ? 'Deactivate' : 'Activate' ?>
                    </a>
                    <a href="landlord-dashboard.php?delete=<?= $t['id'] ?>"
